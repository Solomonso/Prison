...
public class Cell {
     ...
     *
     * @param cellNumber Don't create cells with the same number.
     */
     ...
     * Can only add to prisoners to cell.
    ...
    public void removePrisoner(Prisoner removePrisoner) {
        if (!this.prisonerList.isEmpty()) {
            ...
            System.out.println("cannot remove any more prisoner it's empty");
        }
    }
    ...
    /**
     * The methods gets the details of prisoner in a cell depending if its full or not.
     *
